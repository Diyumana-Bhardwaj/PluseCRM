  ...
  return (
    <main className="flex-1 overflow-y-auto bg-[#FAF8F5] flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-[16px] font-semibold text-[#1A1410]">{label}</p>
        <p className="text-[13px] text-[#9C9691] mt-1">Coming soon</p>
      </div>
    </main>
  );
}
...
function OpportunityCard({ opp }) {
  return (
    <div className={`bg-white rounded-xl p-4 flex flex-col cursor-pointer transition-all duration-150 ${
      ...
      <div className="flex gap-2 mt-auto">
        <button className="flex-1 py-1.5 rounded-lg text-[12px] font-medium bg-[#F3F0EB] border border-black/[0.08] text-[#6B6560] hover:bg-[#EAE7E2] transition-colors">
          View Segment
        </button>
        <button className="flex-1 py-1.5 rounded-lg text-[12px] font-semibold bg-[#FF6B35] text-white hover:bg-[#E55A26] transition-colors">
          Launch →
        </button>
      </div>
    </div>
